1. Gordon Cui,
   **Cost Estimation for Distributed Fault-Tolerant Graph State Preparation**,
   Master's thesis Keio University, Graduate School of Media and Governance, Jul. 2026.
   [available in PDF](publications/syui_mthesis.pdf)
1. Shen Yifeng,
   **Qubit Level Operation on Quantum Testbed**
   Bachelor's thesis, Keio University, Faculty of Environment and Information Studies, Jul. 2026.
   [available in PDF](publications/tomshen_gp2.pdf)
1. Yutaro Yoshii,
   **High-Throughput Optical Testbed Simulation with Rust**
   Bachelor's thesis, Keio University, Faculty of Environment and Information Studies, Jul. 2026.
   [available in PDF](publications/martian_thesis.pdf)
1. Aman Yacob Tekleab
   **Adaptive Polarization Compensation for Optical Interconnects in Quantum Networks**,
   Bachelor's thesis, Keio University, Faculty of Environment and Information Studies, Jul. 2026.
   [available in PDF](publications/aman_gp2.pdf)
1. Ruka Ishikawa
   **Validation of Conservation Laws in a Quantum Vlasov Solver using a 1D Mirror Model**,
   Bachelor's thesis, Keio University, Faculty of Environment and Information Studies, Mar. 2026.
   [available in PDF](publications/lukas_bthesis.pdf)
...
1. Marii Koyama
   **Scalable Optical Switching Architectures for Quantum Photonic Networks**,
   Bachelor's thesis, Keio University, Faculty of Environment and Information Studies, Mar. 2026.
   [available in PDF](publications/mia-bthesis.pdf)
1. Yuta Imahoko
