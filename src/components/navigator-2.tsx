...
export default function Navigation() {
  ...
  return (<NavigationMenu className="py-2 sticky top-0 backdrop-blur-md bg-background/30 w-full">
    <NavigationMenuList className="flex w-full">
      ...
      >
        <Link href='/' legacyBehavior passHref >
          <NavigationMenuLink className={cn(navigationMenuTriggerStyle(), "flex gap-2")}>
            <span className='text-xl'>🌊</span> AQUA
          </NavigationMenuLink>
        </Link>
      </NavigationMenuItem>
      {Links.map((component) => {
